...
contract SupplyChain  is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  modifier harvested(uint _upc) {
    require(items[_upc].itemState == State.Harvested,"Item is not yet harvested");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Processed
  modifier processed(uint _upc) {
    require(items[_upc].itemState == State.Processed, "Item is not yet processed");
    _;
  }
  
  // Define a modifier that checks if an item.state of a upc is Packed
  modifier packed(uint _upc) {
    require(items[_upc].itemState == State.Packed, "Item is not yet packed"); 
    _;
  }
  ...
  modifier shipped(uint _upc) {
    require(items[_upc].itemState == State.Shipped, "Item is not yet shipped");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Received
  modifier received(uint _upc) {
    require(items[_upc].itemState == State.Received, "Item is not yet received");
    _;
  }
